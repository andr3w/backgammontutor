...
// state: checkers borne off, at least this many.
export const off     = (n, why, otherwise)     => goal('off', n, why, otherwise);
// state: points made in your own home board, at least this many.
export const board   = (n, why, otherwise)     => goal('board', n, why, otherwise);
// state: how many different die numbers hit something of yours. Two blots
// behind the same number is one; behind different numbers, two. This is what
// duplication is counted in.
export const numbers = (n, why, otherwise)     => goal('numbers', n, why, otherwise);
