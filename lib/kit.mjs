 ...
 *
 * `next` is the slug of the page to send the student to when they reach the
 * end of this one. Omit it and the ending offers the list of pages instead.
 */
export function page(title, kids, opts = {}) {
  const tree = $m('main', $m('h1', title), kids);
  return { title, tree, questions: collect(tree), next: opts.next || null };
}
